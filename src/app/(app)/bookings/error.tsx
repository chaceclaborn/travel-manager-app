...
export default function BookingsError({
  ...
  return (
    ...
    >
      ...
      <h2 className="text-xl font-semibold text-slate-900">We couldn&apos;t load your bookings</h2>
      <p className="mt-2 text-sm text-slate-500 max-w-sm">
        Something went wrong while loading the bookings page. Please try again, or head back to the dashboard.
      </p>
