          ...
          <>
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className={`text-2xl font-bold ${booking.status === 'CANCELLED' ? 'text-slate-400 line-through' : 'text-slate-800'}`}>
                    {booking.provider}
                  </h1>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {booking.status === 'CANCELLED'
                    ? <><RotateCcw className="mr-1 size-3.5" />{cancelling ? 'Reactivating…' : 'Reactivate'}</>
                    : <><Ban className="mr-1 size-3.5" />{cancelling ? 'Cancelling…' : 'Cancel'}</>
                  }
                </Button>
