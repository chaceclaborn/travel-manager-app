          ...
          <>
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                <span className={`flex items-center justify-center rounded-xl p-3 ring-2 ${config.iconBg} ${isCancelled ? 'opacity-50' : ''}`}>
                  {config.icon}
                </span>
                <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  className={isCancelled ? 'text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 border-emerald-200' : 'text-orange-600 hover:text-orange-700 hover:bg-orange-50 border-orange-200'}
