          ...
          <>
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    ...
                    {isCancelled && (
                      <span className="inline-flex items-center gap-1 rounded-full bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-700 ring-1 ring-red-200">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {isCancelled ? <><RotateCcw className="mr-1 size-3.5" /> Reactivate</> : <><Ban className="mr-1 size-3.5" /> Cancel</>}
                </Button>
