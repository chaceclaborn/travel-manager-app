            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  disabled={cancelling}
                  className={booking.status === 'CANCELLED' ? 'text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50' : 'text-orange-600 hover:text-orange-700 hover:bg-orange-50'}
                  aria-label={booking.status === 'CANCELLED' ? 'Reactivate booking' : 'Cancel booking'}
                >
                  {cancelling ? (
