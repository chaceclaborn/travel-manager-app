          ...
          <>
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className={`text-2xl font-bold ${booking.status === 'CANCELLED' ? 'text-slate-500 line-through' : 'text-slate-800'}`}>{booking.provider}</h1>
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  {cancelling ? '...' : booking.status === 'CANCELLED' ? 'Reactivate' : 'Cancel'}
                </Button>
