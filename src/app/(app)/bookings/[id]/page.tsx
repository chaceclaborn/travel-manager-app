        ...
        {editing ? (
          ...
          <>
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-2">
                <Button size="sm" variant="outline" onClick={() => setEditing(true)} disabled={isCancelled}>
                ...
                <Button
                  ...
                  disabled={cancelling}
                  className={isCancelled ? 'text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50' : 'text-orange-500 hover:text-orange-600 hover:bg-orange-50'}
                >
                  {cancelling ? (
