...
export default function TripDetailError({
  ...
  return (
    ...
    >
      ...
      <h2 className="text-xl font-semibold text-slate-900">We couldn&apos;t load this trip</h2>
      <p className="mt-2 text-sm text-slate-500 max-w-sm">
        Something went wrong while loading the trip details. Please try again, or go back to your trips list.
      </p>
